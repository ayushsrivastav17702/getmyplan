...
const FOOTER_COLS = [
  ...
  { title: "Solutions", links: [
    { label: "Fashion Retail", href: "#" }, { label: "Luxury Goods", href: "#" },
    { label: "Fast Fashion", href: "#" }, { label: "D2C Brands", href: "#" },
    { label: "Multi-Channel Retail", href: "#" },
  ]},
  { title: "Resources", links: [
    { label: "Help Center", href: "/help" }, { label: "Blog", href: "/blog" },
    { label: "API Reference", href: "#" }, { label: "Case Studies", href: "#" },
    { label: "Webinars", href: "#" },
  ]},
  { title: "Company", links: [
    { label: "About", href: "#" }, { label: "Careers", href: "#" },
    { label: "Press", href: "#" }, { label: "Contact", href: "#" },
